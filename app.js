...
const instaDownload = require('./api/routes/instaDownload');
...
mongoose
	...
	.catch((err) => console.log({ error: err, message: 'Server is not connected' }));
...
app.use((req, res, next) => {
	...
	res.header('Access-Control-Allow-Headers', 'Origin, X-Requested-Type, Accept ,Authorization');
